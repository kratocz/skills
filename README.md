...
| [retro](./skills/retro) | Session retrospective — migrate memory facts to AGENTS.md, capture session learnings, audit docs, check the work is committed and pushed | 2026-06-10 |
